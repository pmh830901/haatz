$(document).ready(function(){
    ...
    if($(window).width() >=1281) {
      ...
      $('nav > ul > li').hover(function(){
        ...
        // $('.sub_bg').css('height',subHeight+200)
    ...
    const swiper2 = new Swiper('.support', {
        slidesPerView:1.5,
        spaceBetween:20,
        // 3초마다 자동실행
        autoplay:{
